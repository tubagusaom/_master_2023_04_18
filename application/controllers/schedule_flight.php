...
class Schedule_flight extends MY_Controller {
    ...
    function index() {
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            $grid = $this->grid->set_properties(array('model' => 'v_schedule_model', 'controller' => 'schedule_flight', 'options' => array('id' => 'schedule', 'pagination', 'rows_number')))->load_model()->set_grid();
