...
class Import_tuk extends MY_Controller {
    ...
    function index() {
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            $grid = $this->grid->set_properties(array('model' => 'import_tuk_model', 'controller' => 'import_tuk', 'options' => array('id' => 'import_tuk', 'pagination', 'rows_number')))->load_model()->set_grid();
