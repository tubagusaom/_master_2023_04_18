...
class Schedule_ground extends MY_Controller {
    ...
    function index() {
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            'fields' => array('schedule_date','nama','subject_category','program_study','current_program','instruktur_name','plane_name','from_time','to_time','stage','revision'), 'controller' => 'schedule_ground', 'options' => array('id' => 'schedule_ground', 'pagination', 'rows_number')))->load_model()->set_grid();
