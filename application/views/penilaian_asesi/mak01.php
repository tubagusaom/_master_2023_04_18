...
Menayakan maksud dan tujuan
        ...
        <input hidden type="checkbox" name="mak01[0]" <?php echo (isset($mak01[0]) && $mak01[0]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[0]) && $mak01[0]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
          </td> 
	</tr>
	<tr>
        ...
        <input hidden type="checkbox" name="mak01[1]" <?php echo (isset($mak01[1]) && $mak01[1]=='on'?'checked':''); ?>/>  
        <?php echo (isset($mak01[1]) && $mak01[1]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
        </td> 
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[2]" <?php echo (isset($mak01[2]) && $mak01[2]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[2]) && $mak01[2]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
          </td> 
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[3]" 
        <?php echo (isset($mak01[3]) && $mak01[3]=='on'?'checked':''); ?>/> 
        <?php echo (isset($mak01[3]) && $mak01[3]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[4]" <?php echo (isset($mak01[4]) && $mak01[4]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[4]) && $mak01[4]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[5]" <?php echo (isset($mak01[5]) && $mak01[5]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[5]) && $mak01[5]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
...
Tanggal …, Tempat …. Dan lama  waktu pelaksanaan</td>
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[6]" <?php echo (isset($mak01[6]) && $mak01[6]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[6]) && $mak01[6]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[7]" <?php echo (isset($mak01[7]) && $mak01[7]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[7]) && $mak01[7]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[8]" <?php echo (isset($mak01[8]) && $mak01[8]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[8]) && $mak01[8]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	...
	<tr>
        ...
        asesmen.</td>
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[9]" <?php echo (isset($mak01[9]) && $mak01[9]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[9]) && $mak01[9]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?> 
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[10]" <?php echo (isset($mak01[10]) && $mak01[10]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[10]) && $mak01[10]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?> 
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[11]" <?php echo (isset($mak01[11]) && $mak01[11]=='on'?'checked':''); ?>/> 
        <?php echo (isset($mak01[11]) && $mak01[11]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[12]" <?php echo (isset($mak01[12]) && $mak01[12]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[12]) && $mak01[12]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	...
	<tr>
		...
		<td style="width:40%; text-align:justify;">Berikan peserta umpan balik yang dapat membangun kompetensi nya menjadi
         lebih baik lagi.</td>
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[13]" <?php echo (isset($mak01[13]) && $mak01[13]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[13]) && $mak01[13]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[14]" <?php echo (isset($mak01[14]) && $mak01[14]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[14]) && $mak01[14]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?> 
	</tr>
	...
	<tr>
		...
		<td style="width:15%;text-align: center;"> <input hidden type="checkbox" name="mak01[15]" <?php echo (isset($mak01[15]) && $mak01[15]=='on'?'checked':''); ?>/>
        <?php echo (isset($mak01[15]) && $mak01[15]=='on'?'<i class="icons-check">':'<i class="icons-no_check">'); ?>
	</tr>
    </tbody>
</table>