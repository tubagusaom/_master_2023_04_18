...
<page backtop="25mm" backbottom="10mm" backleft="15mm" backright="15mm">
    <page_header>
        <div>
            <img src="<?php echo site_url().'assets/img/kop_lsp_p2pusat.png';?>" width="750" height="100" />
        </div>
        <br />
    </page_header>
    <page_footer>
    </page_footer>
    <div align="center" style="font-weight: bold; font-size: 14px; margin-top: 0px;">KEPUTUSAN KETUA LSP P2KGK JAKARTA PUSAT </div>
    ...
    <?php
      ...
      echo substr($nomor_keputusan[$value], 0,-7)."/".getRomawi($bln)."/".substr($info_jadwal[$value]->tanggal, 0, 4);
    ?>
    </div>

    <br>
    <div align="center" style="font-weight: bold; font-size: 14px;">TENTANG</div>
    <div align="center" style="font-weight: bold; font-size: 14px;">PELAKSANAAN UJI KOMPETENSI UNTUK <br> SKEMA <?= strtoupper($skema_uji[$value]->skema) ?> </div>
    <div align="center" style="font-weight: bold; font-size: 14px;">DI <?= strtoupper($info_jadwal[$value]->tuk) ?></div>
    <div align="center" style="font-weight: bold; font-size: 14px;">PADA PELAKSANAAN KOMPETENSI TAHUN 2018 </div>
    <hr style="width: 100%;">
    <div align="center" style="font-weight: bold; font-size: 14px; margin-top: 15px;">KETUA LSP P2KGK JAKARTA PUSAT</div>
    <table style="width: 97%; margin-top: 25px;" border="0" class="timbangan">
    	...
    	<tr>
    		...
    		<td style="width: 75%;">
			bahwa untuk itu perlu ditetapkan dengan Surat Keputusan Ketua LSP P2KGK JAKARTA PUSAT
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td style="width: 75%;">
				Surat Keputusan BNSP No. KEP.0710/BNSP/VII/2017 tentang Lisensi kepada LSP P2KGK JAKARTA PUSAT
    		</td>
    	</tr>
    	<tr>
    		<td style="width: 17%;"></td>
    		...
    		<td style="width: 75%;">
				Surat Keputusan LSP P2KGK JAKARTA PUSAT No. KEP <?= (!is_null($info_jadwal[$value]->sk_tuk) && !empty($info_jadwal[$value]->sk_tuk) ? $info_jadwal[$value]->sk_tuk : '.../...') ?> Tentang Lisensi <?= $info_jadwal[$value]->tuk ?>
    		</td>
    	</tr>
    	<tr>
    ...
    <table style="width: 97%;" border="0" cellspacing="10" class="keputusan">
    	<tr>
    		...
    		<td style="width: 80%;">
				...
				pada Pelaksanaan Sertifikasi Tahun 2018
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td style="width: 80%;">
				...
				dan melaporkan hasilnya kepada Ketua LSP P2KGK JAKARTA PUSAT
    		</td>
    	</tr>
    	<tr>
    		...
    		<td style="width: 80%;">
				Kegiatan Pelaksanaan Uji Kompetensi untuk Skema <?= ucwords(strtolower($skema_uji[$value]->skema)) ?> di
				 <?= $info_jadwal[$value]->tuk ?> pada Pelaksanaan Sertifikasi Tahun
                                 2018 akan dilaksanakan pada tanggal <?php echo intval(date('d', strtotime($info_jadwal[$value]->tanggal))).' - '. (substr($info_jadwal[$value]->tanggal, 8, 2) + 1) .' '.getBulan(substr($info_jadwal[$value]->tanggal, 5, 2)).' '.substr($info_jadwal[$value]->tanggal, 0, 4); ?>
    		</td>
    	</tr>
    	<tr>
    		...
    		<td style="width: 3%;" valign="top"> : </td>
    		<td style="width: 80%;">
    			Biaya yang timbul akibat ditetapkannya Keputusan ini dibebankan pada Anggaran Pelaksanaan Sertifikasi LSP P2KGK Jakarta Pusat melalui DPA P2KPTK2 Jakarta Pusat tahun 2018
    		</td>
    	</tr>
    	<tr>
    ...
    <div style="margin-top: 15px;">
    	<span style="text-decoration: underline;"> Tembusan :  </span> <span style="margin-left: 300px;">KETUA LSP P2KGK JAKARTA PUSAT </span>
    </div>
    <div>
...
<page backtop="40mm" backbottom="10mm" backleft="15mm" backright="15mm">
    ...
    <table style="width: 97%; font-weight: bold; font-size: 14px; margin-top: -50px;" border="0">
    	<tr>
    		...
    		<td style="width: 5%;"> : </td>
    		<td style="width: 80%;"> Keputusan Ketua LSP P2KGK JAKARTA PUSAT</td>
    	</tr>
    	<tr>
    		<td style="width: 25%;">Nomor </td>
    		<td style="width: 5%;"> : </td>
    		<td style="width: 80%;"> <?= $nomor_keputusan[$value] ?> </td>
    	</tr>
    </table>
    <div style="text-align: center; font-weight:bold; font-size: 14px; margin-top: 5px;"> TIM PELAKSANAAN UJI KOMPETENSI UNTUK SKEMA <?= strtoupper($skema_uji[$value]->skema) ?>
     </div>
    <div style="text-align: center; font-weight:bold; font-size: 14px;">DI <?= strtoupper($info_jadwal[$value]->tuk) ?></div>
    <div style="text-align: center; font-weight:bold; font-size: 14px;">PADA PELAKSANAAN KOMPETENSI TAHUN 2018</div>
    <table style="width: 97%; border-collapse: collapse; margin-top: 5px;" border="1">
        ...
        <tbody>
            ...
            <tr>
                <td style="width: 10%; font-weight: bold; text-align: center; padding: 2px;">I.</td>
                <td style="width: 45%; font-weight: bold; padding: 2px;">Imam Nurudin, SE</td>
    ...
    <table style="width: 70%; margin-top: 10px;" border="0" align="right">
    	...
    	<tr>
    		<td style="width:30%;">Pada tanggal </td>
    		<td style="width: 5%;"> : </td>
    		<td style="width:30%;"> <?= tgl_indo( date('Y-m-d', strtotime("+5 day", strtotime($info_jadwal[$value]->tanggal_akhir))) );  ?> </td>
    	</tr>
        <tr>
            <td colspan="3" align="center" style="padding-top: 20px;">Ketua LSP P2KGK JAKARTA PUSAT</td>
        </tr>
        <tr>
            <td colspan="3" align="center" style="padding-top: 40px;">(<?= $aplikasi->ketua ?>)</td>
        </tr>
    </table>
</page>
<?php } ?>
