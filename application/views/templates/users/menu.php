					...
					<ul class="main-navigation-menu">
                        ...
                        <li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Persiapan </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
									<a href="<?=base_url()."jadwal_asesmen/index"?>">
										<span class="title"> Jadwal Asesmen </span>
									</a>
								</li>
								<li>
									<a href="layouts_sidebar_closed.html">
										<span class="title"> Penetapan Skema </span>
									</a>
								</li>
								<li>
									<a href="layouts_boxed_layout.html">
										<span class="title"> Penetapan Asesor </span>
									</a>
								</li>
								<li>
									<a href="layouts_footer_fixed.html">
										<span class="title"> Surat Tugas Asesor </span>
									</a>
								</li>
								<!-- <li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Invoice Kolektif </span>
									</a>
								</li> -->
							</ul>
						</li>
