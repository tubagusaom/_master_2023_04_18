                ...
                <form action="<?= base_url() . 'profil/edit' ?>" method="POST" class="form-horizontal form-bordered form-row-stripped">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input required  type="text" placeholder="Nama Lengkap" class="form-control" name="nama_lengkap" value="<?= $biodata->nama_lengkap ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="telp" value="<?= $biodata->telp ?>" required type="text" class="form-control" placeholder="No HP Aktif"> </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="pendidikan_terakhir" value="<?= $biodata->pendidikan_terakhir ?>" required type="text" class="form-control" placeholder="Pendidikan Terakhir">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="jurusan" value="<?= $biodata->jurusan ?>" required type="text" class="form-control" placeholder="Jurusan">
                            </div>
                        </div>
