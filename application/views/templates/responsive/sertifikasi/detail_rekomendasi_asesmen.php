                ...
                <form action="<?= base_url() . 'sertifikasi/save_asesmen' ?>" method="POST" class="form-horizontal form-bordered form-row-stripped">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-9">
                                <a href="<?= base_url() . 'sertifikasi/detail/' . $id ?>" class="btn btn-primary">Kembali</a>
                                <?php if(!is_null($mak05) && !empty($mak05)){ ?>
                                <button type="submit"  id="submitmak" class="btn btn-primary">Save</a>
                                <?php }else{ ?>
								<button type="submit"  id="submitmak" class="btn btn-primary">Save</a>
								<?php } ?>
                            </div>
