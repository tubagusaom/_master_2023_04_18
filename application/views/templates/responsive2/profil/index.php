    ...
    <div class="page-content">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="portlet-body form">
                ...
                <form id="form_profil" action="<?= base_url() . 'profil/edit' ?>" method="POST" class="form-horizontal form-bordered form-row-stripped">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <span class="help-block"> KTP/SIM/Kartu Pelajar/Pasport Number </span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Lengkap <span class="required_span">*</span></label>
                            <div class="col-md-9">
                                <input required  type="text" placeholder="Nama Lengkap" class="form-control" name="nama_user" value="<?= $biodata->nama_lengkap ?>" />
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 date-picker">Tanggal Lahir <span class="required_span">*</span></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="hp" value="<?= $biodata->telp ?>" required type="text" class="form-control" placeholder="No HP Aktif"> </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Sekolah <span class="required_span">*</span></label>
                            <div class="col-md-9">
                                <input name="nama_lembaga" value="<?= $biodata->organisasi ?>" required type="text" class="form-control" placeholder="Nama Sekolah">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Jurusan <span class="required_span">*</span></label>
                            <div class="col-md-9">
                                <input name="pendidikan_terakhir" value="<?= $biodata->jurusan ?>" required type="text" class="form-control" placeholder="Nama Jurusan">
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <button type="submit"  class="btn green" id="profil">
