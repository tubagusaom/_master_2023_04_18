            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                if ($value->administrasi_ujk == '3') {
                                                    ?>
                                                    <a  style="margin: 5px;" class="btn btn-xs blue" href="<?= base_url() . 'pembayaran/form_konfirmasi/'.$value->id.'/'.$value->invoice_no ?>">
                        ...
                        NOTE : Status pembayaran akan dikonfirmasi dan diupdate oleh admin LSP menjadi "SUDAH LUNAS" apabila pembayaran valid.
                    </div>
                </div>
