                                ...
                                <div class="col-md-12 col-xs-12" id="tagPertanyaan">
                                    ...
                                    <label style="font-weight: bold;font-size: 10px;">Unit Kompetensi : <?= $tanya->unit_kompetensi; ?></label><br/>
                                        ...
                                        <?php
                                            ...
                                            <div class="inputbox">
                                                <label><textarea name="opsi[<?=$key?>]"  class="opsi[] form-control"  onclick="inputJawab(<?= $no; ?>);" cols="50" rows="5"> </textarea></label>
                                        </div>
                                            <?php
                                        }
                                        ?>
...
$("#frmUji").submit(function () {
    ...
    $.ajax({
        ...
        success: function (hsl) {
            ...
            if (hsl.msgType == true) {
                alert(hsl.msgValue);
window.location="https://lsp.smkn2-bjm.sch.id/home";
            } else {
                alert(hsl.msgValue);
                $("#btnKirim").show();
            }
